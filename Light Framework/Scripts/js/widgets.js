...
__twttrlr(function (using, provide, loadrunner, define) {
    ...
    provide("tfw/util/assets", function (e) {
        using("util/env", function (t) {
            ...
            var n = {
                "embed/timeline.css": {
                    "default": "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.default.css",
                    "2x": "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.2x.css",
                    gif: "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.gif.css",
                    "default.rtl": "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.default.rtl.css",
                    "2x.rtl": "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.2x.rtl.css",
                    "gif.rtl": "embed/timeline.d61f53cad16dc4575a07a63d6a15e30c.gif.rtl.css"
                }
            };
            e(r)
        })
        ...
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "util/env", "util/promise", "util/util", "util/throttle", "util/twitter", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d) {
            ...
            T.prototype = new n, f.aug(T.prototype, {
                ...
                create: function (e) {
                    ...
                    if (!r) return;
                    return this.theme == "dark" && this.classAttr.push("thm-dark"), this.linkColor && this.addSiteStyles(), s.present(r, "media-forward") && (this.fullBleedPhoto = !0), this.augmentWidgets(r), n.retinize(r), r.id = this.id, r.className += " " + this.classAttr.join(" "), r.lang = this.lang, this.sandbox.setTitle(r.getAttribute("data-iframe-title") || "Tweet"), this.sandbox.appendChild(r), this.sandbox.style({
                        cssText: "",
                        display: "block",
                        maxWidth: "99%",
    ...
    provide("tfw/widget/tweetbutton", function (e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (t, n, r, i, s, o) {
            ...
            l.prototype = new t, n.aug(l.prototype, {
                ...
                render: function (e, t) {
                    var r = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1383953108.html#" + this.parameters(),
                        i;
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function (t, n, r, i, s, o, u) {
            ...
            a.prototype = new n, t.aug(a.prototype, {
                ...
                render: function (e, n) {
                    ...
                    var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1383953108.html#" + this.parameters(),
